...
description: "Crea un usuario administrador en MySQL y accede al panel de control de LUVEN. Incluye el flujo de autenticación, gestión de sesión y cierre de sesión seguro."
---
...
<Steps>
  ...
  <Step title="Cerrar sesión de forma segura">
    ...
    El controlador destruye la sesión PHP activa con `session_destroy()` y redirige al usuario a la página de inicio de sesión. Después del logout, cualquier intento de acceder a una URL de `ADMIN/` directamente resultará en una redirección inmediata al login.
  </Step>
</Steps>
